            ...
            <div class="sign-user_card ">
               <div class="sign-in-page-data">
                  <div class="sign-in-from w-100 m-auto">
                     ...
                     <form class="mt-4" action="{{route('user_profile_parental_password')}}" method="POST">
                            @csrf
                        <div class="form-group">
                           <input type="password" name="password" class="form-control mb-0" id="password" placeholder="Senha do usuário">
                           <small>Informe a senha de acesso</small>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <small>Informe uma senha para acesso a conteúdos restritos</small>
                        </div>
