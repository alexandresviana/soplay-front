            ...
            <div class="sign-user_card ">
               <div class="sign-in-page-data">
                  <div class="sign-in-from w-100 m-auto">
                     <h3 class="mb-3 text-center">Perfil - Alterar senha</h3>
                     ...
                     <form class="mt-4" action="{{route('user_profile_change_password')}}" method="POST">
                            @csrf
                        <div class="form-group">
                           <input type="password" name="password" class="form-control mb-0" id="password" placeholder="Senha atual">
                        </div>
