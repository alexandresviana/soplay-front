                    ...
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="iq-main-header d-flex justify-content-between">
                                <h4 class="main-title">
                                    <a href="{{route('home_filmes')}}">{{$categoria}}</a>
                                </h4>
                            </div>
                            <div class="favorites-contens">
                                <ul class="favorites-slider favorites-slider__aovivo list-inline  slick-slider row p-0 mb-0" >
                                    ...
                                    <li class="slide-item" style="max-width: 250px;">
                                        <a href="{{route('video', ['id' => $conteudo->id])}}">
                                            <div class="block-images position-relative">
                                                <div class="img-box">
                                                    <img src="{{ $conteudo->file ? $conteudo->file->imageUrl : '' }}" style="height: 350px;" class="img-fluid" alt="{{$conteudo->titulo}}" >
                                                </div>
